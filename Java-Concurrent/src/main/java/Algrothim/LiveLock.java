...
public class LiveLock {
    ...
    public static class Dinner {
        public Dinner(boolean isHungry, String name) {
                ...
                synchronized (sharedSpoon) {
                    while (isHungry) {
                        ...
                        while (!sharedSpoon.getOwnerName().equals(name)) {
                            System.out.println("sharedSpoon belongs to " + sharedSpoon.getOwnerName() + ", current dinner is :" + name);
                            sharedSpoon.wait();
                        }
    ...
    public static void main(String[] args) {
        Dinner husband = new Dinner(true, "husband");//创建一个丈夫用餐类
        Dinner wife = new Dinner(true, "wife");//创建一个妻子用餐类
        Spoon sharedSpoon = new Spoon(wife);//创建一个勺子，初始状态并由妻子持有
